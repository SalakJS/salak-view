...
describe('test salak-view', () => {
  ...
  describe('test controller.view()', () => {
    it('should return html', async () => {
      const res = await request(callback).get('/view').expect(200)
  ...
  describe('test context.view()', () => {
    it('should return html', async () => {
      const res = await request(callback).get('/ctxView').expect(200)
